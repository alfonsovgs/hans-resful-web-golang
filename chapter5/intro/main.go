...
func main() {
	...
	collection := client.Database("app").Collection("movies")

	// Create a movie
	darkNigght := Movie{
		Name:      "The Dark Knight",
		Year:      "2008",
		Directors: []string{"Christophr Nolan"},
	...
	_, err = collection.InsertOne(context.TODO(), darkNigght)
	...
	queryResult := &Movie{}
	// bson.M is used for building map forfilter query
